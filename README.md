...
Current version has been tested with Dropwizard 0.9.3 and Swagger 1.5.9 which supports Swagger 2 spec!
...
------------------|------------|-----------|----------
     < 0.5        |   0.7.x    |   1.3.2   |    ?
       ...
       0.9.x      |   0.9.x    |   1.5.9   | v2.1.4
       1.0.0-rc3  |   1.0.0-rc3|   1.5.9   | v2.1.4
